...
// Adapted from React Bits' ParticleText (JS + CSS variant), typed for this
// project. Renders `text` as a field of canvas particles that scatter and
// gather back into the glyphs on `trigger`.
...
const waitForFonts = async (font: string) => {
  ...
  try {
    ...
    // ignore, fall back to whatever font resolves
  }
