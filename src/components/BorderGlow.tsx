...
// Adapted from React Bits' BorderGlow (JS + CSS variant), typed for this
// project. A cursor-reactive glowing border, used to call out the module a
// student hasn't finished yet.
